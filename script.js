...
const toastTranslations = {
  ...
  ro: {title: 'Revendică bonusul',text: 'Înregistrează-te acum și primește un bonus de 500% plus 500FS folosind acest cod promoțional.',code: 'Cod promoțional',button: 'Copiază'},
